...
import SelectBoardModal from './modals/SelectBoardModal'
  ...
  <MyNav>
    <nav className={`flex justify-between px-6  mx-auto items-center border-b ${!isChecked ? 'border-[#E4EBFA]' : 'border-[#3E3F4E]'} fixed left-0 right-0`}>
      ...
      <div className='flex space-x-5 items-center'>
        ...
        <svg width="5" className='cursor-pointer' height="20" xmlns="http://www.w3.org/2000/svg"><g fill="#828FA3" fill-rule="evenodd"><circle cx="2.308" cy="2.308" r="2.308" /><circle cx="2.308" cy="10" r="2.308" /><circle cx="2.308" cy="17.692" r="2.308" /></g></svg>
      </div>
      {ReactDOM.createPortal(<SelectBoardModal open={openNavModal} close={closeNavModal} isModalOpen={isNavModalOpen}  />, portalCont)}
    </nav>
    </MyNav>
  )
}
